              ...
              <div className="glass-card" style={{ padding:'14px 18px' }}>
                ...
                <ul style={{ listStyle:'none' }}>
                  {planned.length ? planned.map((t,i)=>(
                    <li key={i} style={{ display:'flex',gap:8,alignItems:'flex-start',fontSize:15,color:'#374151',lineHeight:1.6,padding:'6px 0',borderBottom:i<planned.length-1?'1px solid rgba(0,0,0,.04)':'none' }}>
